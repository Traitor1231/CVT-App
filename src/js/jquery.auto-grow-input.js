...
$('#email').autoGrowInput({ minWidth: 105, maxWidth: function(){ return $('#grow-email').width()+10; }, comfortZone: 2 });
$(window).resize(function(){$('#email').trigger('autogrow'); });

$('#phone').autoGrowInput({ minWidth: 105, maxWidth: function(){ return $('#grow-phone').width()+10; }, comfortZone: 2 });
